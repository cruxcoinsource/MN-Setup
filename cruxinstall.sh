...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cruxcoin.conf'
CONFIGFOLDER='/root/.cruxcoin'
COIN_DAEMON='cruxcoind'
COIN_CLI='cruxcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/cruxcoinsource/CruxCoin/files/2775528/Crux-Daemon-.Ubuntu-16.04.tar.gz'
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf Crux-Daemon-.Ubuntu-16.04.tar.gz
  cd rev >/dev/null 2>&1
...
addnode=45.55.52.90
addnode=206.189.170.136
addnode=188.166.82.110
addnode=128.199.253.49
addnode=178.62.13.176
addnode=159.89.125.187
addnode=104.248.125.45
addnode=206.81.4.162
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================"
 echo -e "${CYAN}Follow twitter to stay updated.  https://twitter.com/CruxCoin${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}cruxcoin-cli masternode status${NC}"
 echo -e "${GREEN}cruxcoin-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
